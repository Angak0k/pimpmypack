...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/packs.PackContentCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/packs.PackContentUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/packs.PackCreateAdminRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/myinventory/{id}/image": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Item does not belong to user",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/packs.PackOptionsResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "packs.PackContentCreateRequest": {
            "type": "object",
            "required": [
                "item_id",
                "pack_id",
        ...
        "packs.PackContentUpdateRequest": {
            "type": "object",
            "required": [
                "item_id",
                "pack_id",
